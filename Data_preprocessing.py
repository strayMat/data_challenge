...
#!!!!!!!!!!!!!JE n'arrive pas à faire le chemin inverse ie recuperer le nom des categories a partir de leur code....
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
cols = cols[:1] + cols[-2:-1] +  cols[-3:-2]+ cols[-1:] + cols[1:-3]
#print(cols)
df = df[cols]
df['N_Call'] = 1
print(df.head())
